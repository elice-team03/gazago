                ...
                */
                ...
                for (let idx = 0; idx < catagory_list.length; idx++) {
                    ...
                    tempRow.innerHTML = `
                        ...
                        <td class="cus_text_align_center cus_v_align_middle">${element.count ? element.count : 10}</td>
                        <td class="cus_v_align_middle">
                            <div class="control cus_text_align_center">
                                <label class="radio">
                    ...
                    tempRow.querySelector(`#category_btn_del${idx}`).addEventListener('click', async function (e) {
                        e.preventDefault();
                        try {
                            let deleteResponse = await fetch(`http://localhost:5001/api/categories/${element._id}`, {
                                method: 'DELETE',
                            });
